...
| `MiniApps/Scripts/` | Source các tác vụ PowerShell; Developer net48 nhúng phần Optimize vào helper, output WPF chỉ giữ script Install |
| `MiniApps.OptimizeEngine/` | EXE net48 chạy silent, chứa ZIP xác định của Win11Debloat và các script Optimize |
